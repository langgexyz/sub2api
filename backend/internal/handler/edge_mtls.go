...
func NewCCDirectMTLSGuard() (*CCDirectMTLSGuard, error) {
	...
	return &CCDirectMTLSGuard{pool: pool}, nil
}

// Enabled reports whether mTLS enforcement is active.
func (g *CCDirectMTLSGuard) Enabled() bool { return g != nil && g.pool != nil }

// Middleware verifies the client certificate when enforcement is enabled.
func (g *CCDirectMTLSGuard) Middleware() gin.HandlerFunc {
