...
func TestGetModelPricing_OpenAICompactAliasesFallback(t *testing.T) {
	...
	tests := []struct {
		...
		{model: "gpt5.6", inputPrice: 5e-6, outputPrice: 30e-6, cacheRead: 0.5e-6, longContext: 272000},
...
func TestCalculateCost_OpenAIGPT55ProUsesGPT55PricingPolicy(t *testing.T) {
	...
	// GPT-5.5 Pro 官方 $30/$180（fallback 不再沿用 GPT-5.4 的 $2.5/$15 旧价），
	// 长上下文仍按 legacy 272k 阈值 2.0/1.5 倍率。
...
func TestGetFallbackPricing_FamilyMatching(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "claude opus 4.8 dot", model: "claude-opus-4.8-20260301", expectedInput: 5e-6},
		{name: "claude opus 4.8 dash", model: "claude-opus-4-8", expectedInput: 5e-6},
		{name: "claude opus 4.0 keeps legacy 15/75", model: "claude-opus-4-0", expectedInput: 15e-6},
		{name: "claude opus 4.1 keeps legacy 15/75", model: "claude-opus-4-1-20250805", expectedInput: 15e-6},
		{name: "claude opus 3 keeps legacy 15/75", model: "claude-3-opus-20240229", expectedInput: 15e-6},
		{name: "claude opus unknown future defaults to latest 5/25 not legacy", model: "claude-opus-4-9", expectedInput: 5e-6},
		{name: "claude sonnet 5", model: "claude-sonnet-5", expectedInput: 2e-6},
		{name: "claude sonnet 5 dated (digit 4 in date)", model: "claude-sonnet-5-20260415", expectedInput: 2e-6},
		{name: "claude sonnet 4.5 keeps 3/15", model: "claude-sonnet-4-5-20250929", expectedInput: 3e-6},
		{name: "claude sonnet 3.7 keeps 3/15", model: "claude-3-7-sonnet-20250219", expectedInput: 3e-6},
		{name: "claude sonnet 3.5 keeps 3/15", model: "claude-3-5-sonnet-20241022", expectedInput: 3e-6},
		{name: "claude haiku 4.5", model: "claude-haiku-4-5-20251001", expectedInput: 1e-6},
		{name: "claude haiku unknown future defaults to 4.5 price", model: "claude-haiku-5", expectedInput: 1e-6},
		{name: "claude haiku 3.5 keeps 1/5", model: "claude-3-5-haiku-20241022", expectedInput: 1e-6},
		{name: "claude haiku 3 keeps 0.25/1.25", model: "claude-3-haiku-20240307", expectedInput: 0.25e-6},
		{name: "claude fable 5 mythos tier 10/50", model: "claude-fable-5", expectedInput: 10e-6},
		{name: "claude mythos 5 mythos tier 10/50", model: "claude-mythos-5", expectedInput: 10e-6},
		...
		{name: "openai gpt5.6 dated", model: "gpt-5.6-2026-04-23", expectedInput: 5e-6},
		{name: "openai gpt5.6 luna tier", model: "gpt-5.6-luna", expectedInput: 1e-6},
		{name: "openai gpt5.6 sol tier", model: "gpt-5.6-sol", expectedInput: 5e-6},
		{name: "openai gpt5.6 terra tier", model: "gpt-5.6-terra", expectedInput: 2.5e-6},
		{name: "openai gpt5.5 updated to 5/30", model: "gpt-5.5", expectedInput: 5e-6},
