...
func init() {
	...
	// groupDescSubscriptionSlots is the schema descriptor for subscription_slots field.
	groupDescSubscriptionSlots := groupFields[14].Descriptor()
	// group.DefaultSubscriptionSlots holds the default value on creation for the subscription_slots field.
	group.DefaultSubscriptionSlots = groupDescSubscriptionSlots.Default.(int)
