    ...
    settings: {
      ...
      features: {
        ...
        subscriptions: {
          ...
          description: 'Controls the "My Subscriptions" entry in the user sidebar. Enabled by default.',
          enabled: 'Enable My Subscriptions',
          enabledHint: 'When off, the "My Subscriptions" entry in the user sidebar is hidden.',
        },
        riskControl: {
          title: 'Risk Control',
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for CCDirect end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for CCDirect end-user login',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on CCDirect orders; the upstream type is sent as EasyPay type.',
      ...
      openaiFastPolicy: {
        ...
        userIdsHint: 'Type any part of a user email to search. Leave empty to apply to all CCDirect users. Selected users match requests from their API keys and take precedence over global rules.',
